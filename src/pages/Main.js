            ...
            <div class="flex justify-center pt-5 px-5">
                <div class="max-w-4xl bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    <div class="p-5">
                        ...
                        <a href="minecraft://?addExternalServer=%C2%A7a%C2%A7lFarlands|far-lands.top:19132" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                            Зайти на сервер
